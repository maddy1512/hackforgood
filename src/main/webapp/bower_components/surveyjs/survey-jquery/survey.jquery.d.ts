/*Type definitions for Survey JavaScript library v1.0.54
...
export declare class Survey extends SurveyModel {
    ...
    koIsFirstPage: any;
    koIsLastPage: any;
    koIsNavigationButtonsShowing: KnockoutObservable<boolean>;
    dummyObservable: any;
    koState: any;
    koProgress: any;
    koProgressText: any;
...
export declare class QuestionFileImplementor extends QuestionImplementor {
    ...
    koHasValue: KnockoutComputed<boolean>;
    koData: KnockoutComputed<any[]>;
    koInputTitle: KnockoutObservable<string>;
    constructor(question: Question);
    protected updateValue(newValue: any): void;
}
...
export declare class QuestionMatrixBaseImplementor extends QuestionImplementor {
    ...
    protected onColumnLayoutChanged(): void;
    ...
    protected onVisibleRowsChanged(): void;
...
export declare class JsonObject {
    ...
    protected valueToJson(obj: any, result: any, property: JsonObjectProperty, storeDefaults?: boolean): void;
...
export declare class PanelModelBase extends SurveyElement implements IPanel, IConditionRunner, ILocalizableOwner {
        ...
        /**
            ...
            */
        addNewQuestion(questionType: string, name?: string): Question;
        /**
